...
function Player(id) {
  ...
  this.multipleHit = 0;     // multiple hit shot
  this.shot=0;              // shot = 1 indicate player shot, shot=0 otherwise
  this.username=null;      //player username
...
Player.prototype.shoot = function(gridIndex) {
  if(this.shipGrid[gridIndex] >= 0) {
    ...
    //console.log("MULTIPLE HIT: " + this.multipleHit);
    this.shot=1;
