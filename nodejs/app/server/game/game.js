...
*/
BattleshipGame.prototype.getPlayerScore = function(player) {
  return this.players[player].score;
};

/**
* @brief Get the value of miss of the player
* @param player player instance
* @retval 1 if miss
* @retval 0 otherwise
*/
BattleshipGame.prototype.getPlayerMiss = function(player) {
  return this.players[player].miss;
};

/**
* @brief Get the value of shot of the player
* @param player player instance
* @retval 1 if player shot
* @retval 0 otherwise
*/
BattleshipGame.prototype.getPlayerShot = function(player) {
  return this.players[player].shot;
};
